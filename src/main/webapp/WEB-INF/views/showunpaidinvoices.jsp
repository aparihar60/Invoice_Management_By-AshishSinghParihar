...
<script type="text/javascript">
	function surdel(ii) {
		...
		if (res == true) {
			window.location.href = "editstatus.html?invoiceId=" + ii;
			return true;
		} else if (res == false) {
			return false;
		}
...
<body>
	...
	<h2 align="center">List of Unpaid Invoices</h2>
	<table id="results" align="center" cellpadding="2" cellspacing="1"
		...
		<c:forEach items="${invoicelist}" var="invoice">
			<tr>
				...
				<td>${invoice.tenant.currencyformat}${invoice.invoiceprice}</td>
				...
				<td><a href="javascript:"
					onclick="surdel('${invoice.invoiceid}')">Paid</a></td>
