...
<script type="text/javascript">
	function surdel(ii) {
		...
		if (res == true) {
			window.location.href = "deleteclient.html?clientId=" + ii;
			return true;
		} else if (res == false) {
			return false;
		}
	...
	<div>
		<h2 align="center">
			<a style="font-family: sans-serif; font-size: large; color: black"
				href="addclient.html"><b><i>Add Client</i></b></a>
		</h2>
	...
	<table id="results" align="center">
		...
		<c:forEach items="${clientlist}" var="client">
			<tr>
				...
				<td><a href="editclient.html?clientId=${client.clientid}">Edit</a></td>
				<td><a href="javascript:"
					onclick="surdel('${client.clientid}')">Delete</a></td>
